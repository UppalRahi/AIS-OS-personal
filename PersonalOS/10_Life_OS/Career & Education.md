...
```mermaid
graph TD
    NIT[NIT Srinagar: Mech Eng 2021-2025] --> Traway[Traway: Co-founder & GTM 2022-2024]
    NIT --> BoldBites[BoldBites: Co-founder 2023]
    NIT --> IITD[IIT Delhi: Robotics Martian Rover Intern 2023-2024]
    Traway --> Varidus[Varidus Singapore: Startup Advisor 2024-2025]
    BoldBites --> Ecoyaan[Ecoyaan: Growth Analyst 2024-2025]
    Ecoyaan --> GJ[GrowthJockey: AI Automation Associate 2025]
    Varidus --> GJ
    GJ --> Amply[Amply Google-backed: Founding GTM Sep 2025-Present]
```
